        ...
        <div className="about-area">
          ...
          <div className="about-area-text">
            <p>
              ...
              redes de contatos televirtuais em todo o Brasil. Viabilizamos
              apoiar e acolher pessoas que tenham seus direitos fundamentais
      ...
      <Helping id="preciso-ajuda">
        <div className="helping-area">
          ...
          <div className="helping-area-text">
            <p>
              Se você está passando por algum tipo de violência, estamos aqui
              para te apoiar. A PaisAfetivos compreende a emergência das
              questões violadoras de dignidade humana, principalmente da
              população LGBTQ+ e por isso contamos com uma equipe
